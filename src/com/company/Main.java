...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        out.println("\n" + humanCount +" People in the Night Club tonight, they are:");
        ...
        for (int i=0;i<humanCount;i++){
            out.println("ID "+i+" NAME "+humans[i][0]+" SKILLS "+humans[i][1]);
        }
        ...
        for (int T=0; T<=NIGHT_DURATION; T=T+SONG_DURATION){
            ...
            for (int i=0;i<humanCount;i++){
                ...
                if (mySong == true) {
                    out.println(humans[i][0] + " dance!");
                } else if (mySong == false) {
                    out.println(humans[i][0] + " goes for vodka!");
                }
            }
